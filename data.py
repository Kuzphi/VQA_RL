...
def Get_Data(input_img_h5_train, input_ques_h5_tarin, input_img_h5_test, input_ques_h5_test):
	with h5py.File(input_ques_h5,'r') as hf:
		emb_matrix = np.array(hf.get('emb_matrix'))
	train_img_feature, train_data = Load_data(input_img_h5_train, input_ques_h5_tarin)
	test_img_feature, test_data = Load_data(input_img_h5_test, input_ques_h5_test)
